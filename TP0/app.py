...
boton_activar_seleccion = tk.Button(zona_botones, text='Activar Seleccion', command = lambda: cambiar_modo_seleccion(panel_original, panel_modificado, boton_activar_seleccion, modo_seleccion))
...
panel_original.bind('<Button-1>', lambda event: obtener_valor_pixel(event, txt_herramientas, modo_seleccion, imagen_original))
